...
int main()
{
    ...
    do
    {
        ...
        switch (choiceNumber)
        {
            ...
            case 1:
                ...
                // build PATTERN 1 if valid input
            ...
            case 2:
                ...
                // build PATTERN 2 if valid input
                for (int i = 1; i <= size; i++)
                {
            ...
            case 3:
                ...
                // build PATTERN 3 if valid input
                for (int i = 1; i <= size; i++)
                {
            ...
            case 4:
                ...
                // build PATTERN 4 if valid input
                for (int i = 1; i <= size; i++)
                {
                    for (int k = size; k> i; k--) // generate and decrease the pound signs
                        cout << '#';
    ...
    } while (choiceNumber != 5); // while choosing option 5, exit the loop
