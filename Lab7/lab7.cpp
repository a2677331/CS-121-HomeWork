...
double calcMean(double grade1, double grade2, double grade3) // function for the the solution of average
{
	double mean;
...
double calcDev(double mean, double grade1, double grade2, double grade3)  // function for the solution of deviation
	double deviation;
...
void printResults(double mean, double deviation) // function for outputing result
{
